...
# 26 "traverse_spiral.c" 2


# 27 "traverse_spiral.c"
char *COMMA = ",";
...
# 44 "traverse_spiral.c"
void get_dimensions(FILE *fp, int *size) {
    char *first_line = 
# 45 "traverse_spiral.c" 3 4
                      ((void *)0)
# 45 "traverse_spiral.c"
                          ;
    size_t len = 0;
...
int main(int argc, char *argv[]) {
    ...
    ifp = fopen(argv[1], "r");
    if (ifp == 
# 152 "traverse_spiral.c" 3 4
              ((void *)0)
# 152 "traverse_spiral.c"
                  ) {

        fprintf(
# 154 "traverse_spiral.c" 3 4
               stderr
# 154 "traverse_spiral.c"
    ...
    char *line = 
# 174 "traverse_spiral.c" 3 4
                ((void *)0)
# 174 "traverse_spiral.c"
                    ;
    size_t len = 0;
    char *token = 
# 176 "traverse_spiral.c" 3 4
                 ((void *)0)
# 176 "traverse_spiral.c"
                     ;
    for (int i = 0; i < dimen; i++) {
        ...
        for (int j = 0; j < dimen; j++) {
            *(*(store_array + i) + j) = atoi(token);
            token = strtok(
# 187 "traverse_spiral.c" 3 4
                          ((void *)0)
# 187 "traverse_spiral.c"
                              , COMMA);
        }
    }
    ...
    sq -> size = dimen;
    sq -> array = store_array;



    ofp = fopen(argv[2], "w");
    if (ofp == 
# 200 "traverse_spiral.c" 3 4
              ((void *)0)
# 200 "traverse_spiral.c"
                  ) {

        fprintf(
# 202 "traverse_spiral.c" 3 4
               stderr
# 202 "traverse_spiral.c"
                     , "Cannot open file for reading.");
        exit(1);
    }
